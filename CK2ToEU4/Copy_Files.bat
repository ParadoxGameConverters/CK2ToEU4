...
copy "Data_Files\configuration_l_english.yml" "..\Release\Configuration\"
copy "Data_Files\configuration_l_french.yml" "..\Release\Configuration\"
copy "Data_Files\options_l_english.yml" "..\Release\Configuration\"
copy "Data_Files\options_l_french.yml" "..\Release\Configuration\"
