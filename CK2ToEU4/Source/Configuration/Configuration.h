...
class Configuration: commonItems::parser
{
  ...
  private:
	...
	void verifyCK2Version(const mappers::ConverterVersion& converterVersion) const;
	...
	[[nodiscard]] std::optional<GameVersion> getChangelogVersion(const std::string& filePath) const;
