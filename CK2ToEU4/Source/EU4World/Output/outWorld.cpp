...
void EU4::World::outputHistoryProvinces(const Configuration& theConfiguration, const std::set<std::string>& premades, const bool& isLeviathanDLCPresent) const
{
	if (isLeviathanDLCPresent)
	{
		...
		commonItems::TryCopyFile("configurables/monuments/great_projects/200_songhai-origins_monuments.txt",
			 "output/" + theConfiguration.getOutputName() + "/common/great_projects/200_songhai-origins_monuments.txt");
