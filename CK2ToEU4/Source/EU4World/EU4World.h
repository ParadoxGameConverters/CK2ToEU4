...
class World
{
  ...
  private:
	...
	void outputReformedReligions(const Configuration& theConfiguration, bool noReformation, std::vector<mappers::ReformedReligionMapping>, std::vector<mappers::ReformedReligionMapping>) const;
