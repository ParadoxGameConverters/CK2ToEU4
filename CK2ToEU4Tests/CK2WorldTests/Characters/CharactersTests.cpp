...
TEST(CK2World_CharactersTests, charactersDynastyLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"([WARNING] Dynasty ID: 34 has no definition!)"));
}
...
TEST(CK2World_CharactersTests, charactersLiegeLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"([WARNING] Liege ID: 33 has no definition!)"));
}
...
TEST(CK2World_CharactersTests, charactersPrimaryTitleLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"([WARNING] Primary title ID: k_test has no definition!)"));
}
...
TEST(CK2World_CharactersTests, charactersPrimaryBaseTitleLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"([WARNING] Base title ID: c_skyward has no definition!)"));
}
...
TEST(CK2World_CharactersTests, charactersCapitalLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"( [WARNING] Capital barony ID: b_test has no definition!)"));
}
...
TEST(CK2World_CharactersTests, charactersFatherLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"([WARNING] Father ID: 21 has no definition!)"));
}
...
TEST(CK2World_CharactersTests, charactersMotherLinkCannotBeSetThrowsWarning)
{
	...
	EXPECT_THAT(stringLog, testing::HasSubstr(R"([WARNING] Mother ID: 19 has no definition!)"));
}
